...
using UploadArquivosAPI.Repository;

namespace UploadArquivosAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app , IHostingEnvironment env)
        {
            ...
            app.UseCors("UploadFiles");
            app.UseHttpsRedirection();
            app.UseStaticFiles();
            app.UseMvc(routes =>
                routes.MapRoute(
                    name: "default" ,
                    template: "{controller=Arquivo}/{action=GetArquivos}/{id?}"));
        }
    }
}
